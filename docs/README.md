...
| [design-system.md](design-system.md) | Quyết định QML: Fshare.Components chuẩn, FsAurora.Theme token; bảng ánh xạ atom. |
| [i18n-audit.md](i18n-audit.md) | Rà soát i18n: độ phủ qsTr/tr, trạng thái bản dịch EN, khuyến nghị. |
